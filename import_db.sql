...
INSERT INTO
    users(fname, lname)
VALUES
    ('Sara','Sampson'), ('Chris', 'Thompson');

INSERT INTO
    questions(title, body, associated_author_id)
VALUES
    ('Q1', 'Does this work?', 1), ('Q2', 'Can you do this twice?', 2);
...
INSERT INTO
    replies(questions_id, parent_reply_id, author_id, reply_body)
VALUES
    (1, NULL, 2, "I hope so.");

INSERT INTO
    question_likes(questions_id, author_id)
VALUES
    (1, 2);
